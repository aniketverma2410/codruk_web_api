...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Cancelled Rides for <?php echo ucfirst($customer['name']).' - '.$customer['mobile'];?>
      </h1>
      <ul class="nav nav-tabs">
          <li><a  href="<?php echo base_url($pending)?>">Pending</a></li>
          <li><a  href="<?php echo base_url($completed)?>">Completed</a></li>
          <li><a  href="<?php echo base_url($running)?>">Running</a></li>
          <li class="active"><a href="<?php echo base_url($cancel)?>">Cancelled</a></li>
          <li><a  href="#">Schedule</a></li>

        </ul>
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url('admin-dashboard'); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Cancel Rides</a></li>
