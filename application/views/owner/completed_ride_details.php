    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url('admin-dashboard'); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
         <li><a href="" onclick="window.history.go(-1); return false;"><i class="fa fa-dashboard"></i>Pending Rides</a></li>
            ...
            <div class="box-body">
               ...
               <?php }?>
                ...
                <?php  if (!empty($ridedata['insuranceType'])) {?>
                  ...
                  <div class="row">
                  <div class="col-sm-12 padding0">
                      <label class="col-xs-4">Insurance (<?php echo $currency['currency']?>):</label>
                       <div class="col-xs-8">
                       <input type="text" class="form-control"  value="<?php echo $ridedata['insuranceCharge']?>" disabled="" placeholder="0.00">
                     </div>
                  </div>
                </div>
          ...
          <div class="box">
           <div  id="hiddenSms"><?php echo $this->session->flashdata('message'); ?></div>
            ...
            <div class="box-body">
                ...
                <div class="row">
                  <div class="col-sm-12">
                      <h3>Insurance and Destination Details</h3>
                  </div>
                </div>   

                <hr>

              <?php  if (!empty($ridedata['loader_id'])) {?>

                 <?php  $loderdata = $this->db->get_where('loader_master',array('id'=>$ridedata['loader_id']))->row_array(); ?> 

                <div class="row">
                  <div class="col-sm-6">
                      <label>Loader:</label>
                       <input type="text" class="form-control" value="<?php echo ucfirst($loderdata['name']) ?>" disabled="">
                  </div>
                ...
                <div class="row">
                  <div class="col-sm-6">
                      <label>Insurance Details:</label>
                       <input type="text" class="form-control" value="<?php echo $insuranceData['name']; ?>" disabled="">
                  </div>

                  <div class="col-sm-6">
                      <label>Insurance Price (<?php echo $currency['currency']?>):</label>
                       <input type="text" class="form-control" value="<?php echo $insuranceData['rate']; ?>" disabled="">
                  </div>
                </div>
                &nbsp;
           ...
           <div  id="hiddenSms"><?php echo $this->session->flashdata('message'); ?></div>
            ...
            <div class="box-body">
               ...
               <div class="row">
                ...
                <div class="row">
                  <div class="col-sm-12">
                      <label>Booking Accept Date & Time:</label>
                      <?php if (!empty($bookingData['accept_date'])) 
                      { ?>
                       <input type="text" class="form-control" disabled="" value="<?php echo date('dS M Y h:i A',$bookingData['accept_date'])?>">
                     <?php }else{?>
                ...
                <div class="row">
                  <div class="col-sm-12">
                      <label>Booking Completed Date & Time:</label>
                       <input type="text" class="form-control" disabled="" value="<?php echo date('dS M Y h:i A',$ridedata['completed_date'])?>">
                  </div>
                </div>
                &nbsp;
            ...
            <div class="box-body">
                ...
                <div class="row">
                  <div class="col-sm-12">
                      ...
                      ?>
                      <span class="top"><?php echo round($rating['rating']).'.0'.'&nbsp;&nbsp;'  ?></span>
                 ...
                 <div class="row">
                  <div class="col-sm-12">
                      <label>Comment:</label>
                      <?php $com = $this->db->get_where('comment_master',array('id'=>$rating['comment_id']))->row_array(); ?>
                      <textarea class="form-control" disabled=""><?php echo ucfirst($com['comment']) ?></textarea>
                  </div>
                </div>
                &nbsp;
                ...
                <div class="row">
                  <div class="col-sm-12">
                      <label>Remark:</label>
                      <textarea class="form-control" disabled=""><?php echo ucfirst($rating['remark']) ?></textarea>
                  </div>
                </div>
                &nbsp;
