  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
        ...
        $vehicles = $this->db->get_where('owner_vehicle_master',array('owner_id'=>$owner_detail['id']))->num_rows();
        $loaders = $this->db->get_where('loader_master')->num_rows();
        $Insurance = $this->db->get_where('insurance_master')->num_rows();

        $totalaccepted   = $this->db->get_where('ride_master',array('vehicle_owner_id'=>$owner_detail['id'],'status'=>4))->num_rows();
        $totalcancel   = $this->db->get_where('ride_master',array('vehicle_owner_id'=>$owner_detail['id'],'status'=>2))->num_rows();
        $totalcompleted   = $this->db->get_where('ride_master',array('vehicle_owner_id'=>$owner_detail['id'],'status'=>3))->num_rows();
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            ...
            <a href="<?php echo base_url('owner/manageVehicle'); ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
         ...
         <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <a href="<?php echo base_url('Owner/running_rides'); ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            ...
            <a href="<?php echo base_url('Owner/cancel_rides'); ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
         ...
         <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <a href="<?php echo base_url('Owner/completed_rides'); ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
