...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ul class="nav nav-tabs">
          ...
          <li class="active" ><a  href="<?php echo base_url('owner/update_route_permit/'.$id) ?>">Route Permit</a></li>
        ...
        <div class="col-xs-12">
          <div class="box">
           <div  id="hiddenSms"><?php echo $this->session->flashdata('message'); ?></div>
            <!-- /.box-header -->
            <div class="box-body">
                <form class="form-horizontal" action="<?php echo base_url('owner/update_route_permit'); ?>" enctype="multipart/form-data"  method="post" id="myForm" > 
