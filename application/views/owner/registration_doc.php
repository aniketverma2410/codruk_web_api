...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ul class="nav nav-tabs">
          ...
          <li class="active" ><a  href="#">Registration Documents</a></li>
        ...
        <div class="col-xs-12">
          <div class="box">
           <div  id="hiddenSms"><?php echo $this->session->flashdata('message'); ?></div>
            <!-- /.box-header -->
            <div class="box-body">
                <form class="form-horizontal" action="<?php echo base_url('owner/registration_doc'); ?>" enctype="multipart/form-data"  method="post" > 
                ...
                <div class="row">
                  <div class="col-sm-6">
                     ...
                     <!--  <input type="file" name="vehicle_reg_front" class="form-control" id="thumbnail" class="form-control" accept="image/*" required=""/>
                  ...
                  <div class="col-sm-6">
                     ...
                     <!--  <input type="file" name="vehicle_reg_back" class="form-control" id="thumbnail1" class="form-control" accept="image/*" required=""/>
