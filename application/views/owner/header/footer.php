<footer class="main-footer">
  <strong>Copyright &copy; <?php echo date('Y').'-'.(date('Y') + 1); ?> <a href="#"><?php echo ProjectName; ?></a>.</strong> All Rights
  Reserved.
</footer>

 <link rel="stylesheet" href="<?php echo base_url(); ?>theme/Data_Table/buttons.dataTables.min.css">
  ...
  <script src="<?php echo base_url('theme/'); ?>dist/js/demo.js"></script>
     <script type="https://adminlte.io/themes/AdminLTE/bower_components/jquery/dist/jquery.min.js"></script>
