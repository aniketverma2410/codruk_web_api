        ...
        <div class="col-xs-6">
          <div class="box">
           <div  id="hiddenSms"><?php echo $this->session->flashdata('message'); ?></div>
            <!-- /.box-header -->
            <div class="box-body">
                <form class="form-horizontal" action="<?php echo base_url('Admin/updateInsurancePost'); ?>" enctype="multipart/form-data"  method="post" > 
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3" style="padding-left: 0px;">
                          ...
                          <?php foreach ($capacity as $key => $value) { ?>
                            <option value="<?php echo $value['id']; ?>" <?php echo ($value['id'] == $result['unitId']) ? "selected" : ""; ?>><?php echo $value['name']; ?></option>
                           <?php } ?>
                          </select>
                        </div>  
                    </div>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-12">
                      ...
                      <div id="showFile" style="border: 2px solid #dedadad9;padding: 5px;width: 150px;">
                        <img id="blah" src="<?php echo base_url('mediaFile/insurance/'); ?><?php echo $result['image']; ?>" alt="your image" width="100%" height="100" />
