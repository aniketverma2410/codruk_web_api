...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Manage Loaders</a></li>
        <li class="active">Update Loader</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
           <div  id="hiddenSms"><?php echo $this->session->flashdata('message'); ?></div>
            <!-- /.box-header -->
            <div class="box-body">
                <form class="form-horizontal" action="<?php echo base_url('Admin/updateLoaderPost'); ?>" enctype="multipart/form-data"  method="post" > 
               ...
               <input type="hidden" name="id" value="<?php echo $result['id']; ?>">
                <div class="row">
                  ...
                  <div class="col-sm-6">
                      <label>Loader Count:</label>
                       <input type="number" class="form-control" name="loaderCount" value="<?php echo $result['loaderCount']; ?>">
                  </div>
                </div> <br> 
                ...
                <div class="row">
                  <div class="col-sm-6">
                      <label>Rate(<?php echo $currency['currency']; ?>):</label>
                  ...
                  <div class="col-sm-6">
                      ...
                      <div id="showFile" style="border: 2px solid #dedadad9;padding: 5px;width: 150px;">
                        <img id="blah" src="<?php echo base_url('mediaFile/loaders/'); ?><?php echo $result['image']; ?>" alt="your image" width="100%" height="100" />
