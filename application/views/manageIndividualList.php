...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Manage Individual Customers</a></li>
                      ...
                      <?php } ?> 
                       ...
                       <td><?php 
                          ...
                          <?php } ?></td>
                            ...
                            <td><a href="<?php echo base_url('Customers/riderate/'); ?><?php echo $list['id']; ?>?page=2" title="" class="btn btn-warning btn-sm">Rate</a></td>

                       <td><a href="<?php echo base_url('Customers/updateCustomers/'); ?><?php echo $list['id']; ?>/2" title="" class="btn btn-info btn-sm">View/Edit</a></td>
                      </tr>
                    <?php $count++; } ?>        
