      ...
      <h1>Manage Comments</h1>
        <ol class="breadcrumb" style="padding: 0px 5px;">
            <li>
              ...
              <a href="<?php echo base_url('Admin/addcomment'); ?>" style="color: #fff !important;" class="btn btn-info" >
                Add Comment
              </a>  
            </li>
        </ol>
                    ...
                    foreach($result as $list){ 
                     ...
                     <tr>
                       ...
                       <td><?php 
                          ...
                          <?php } ?></td>
                       <td><a href="<?php echo base_url('Admin/updatecomment/').$list['id']; ?>" class="btn btn-info btn-sm">View/Edit</a></td>
                      </tr>
                    <?php $count++; } ?>        
