        ...
        <div class="col-xs-12">
          <div class="box">
           <div  id="hiddenSms"><?php echo $this->session->flashdata('message'); ?></div>
            <!-- /.box-header -->
            <div class="box-body">
                <form class="form-horizontal" action="<?php echo base_url('Admin/staff_profile'); ?>" enctype="multipart/form-data"  method="post" > 
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                      <label>Email:</label>
                       <input type="email" class="form-control" name="email" value="<?php echo $reg['email']; ?>" readonly="">
                  </div>
                </div> <br> 
                ...
                <div class="row">
                  <div class="col-sm-6">
                      ...
                      <input type="password" class="form-control" name="password" value="<?php echo $reg['password']; ?>">
                  </div>
                  ...
                  <div class="col-sm-6">
                      ...
                      <div id="showFile">
                        ...
                        {
                          $img = base_url('mediaFile/staff/'.$reg['profile_pic']);
                        }
                        else
                        {
                           $img = base_url('mediaFile/image_1555428788.jpg');
                        }
                          ?>
                        
                        <img id="blah" src="<?php echo $img; ?>" alt="your image" style="width:150px;height: 150px;" class="img-circle"/>
                  </div>
                </div> 
                </div><br> 
