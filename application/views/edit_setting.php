...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>Edit Notification Definition Details </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url('admin/welcome/dashboard'); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="<?php echo base_url('admin/NotificationS/viewSetting'); ?>"> Manage Definition</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <!-- form start -->
                    ...
                    <?php echo form_open_multipart('welcome/editSetting',array('id'=>'editpersonalinfo', 'class'=>'editpersonalinfo')); ?>
                           ...
                           <div class="error_validator">
                            ...
                            <input type="hidden" name="definition_id" value="<?= $definition_id; ?>">
                                ...
                                <div class="form-group col-sm-12 col-xs-12 manage_divP">
                                    ...
                                    <div  class="col-xs-9">
                                        <input type="text" class="form-control" placeholder="Definition Name" name="definition" value="<?= $res['name']; ?>" id="definition">
...
<script src="<?php echo base_url(); ?>assets/admin/js/map.js" type="text/javascript"></script>
