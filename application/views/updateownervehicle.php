    ...
    <section class="content-header">
      <h1>
       ...
       <ul class="nav nav-tabs">
          <li class="active" ><a  href="<?php echo base_url('Admin/updateownervehicle/'.$id) ?>">Registration</a></li>
        ...
        <div class="col-xs-12">
          <div class="box">
           <div  id="hiddenSms"><?php echo $this->session->flashdata('message'); ?></div>
            <!-- /.box-header -->
            <div class="box-body">
                <form class="form-horizontal" action="<?php echo base_url('Admin/updateownervehicle'); ?>" enctype="multipart/form-data"  method="post" > 
                   ...
                   <div class="col-sm-6">
                      ...
                      <select name="owner" class="form-control" required="">
                        ...
                        <?php foreach ($owners as $key => $value) {?>
                          <option value="<?php echo $value['id']?>"<?php if ($value['id'] == $vehicleData['owner_id']) {
                            echo "selected";
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                      ...
                      <select class="form-control" name="status">
                        <option value="1" <?php echo ($vehicleData['admin_approval'] == 1) ? 'selected' : '' ?>>Activated</option>
                        <option value="2" <?php echo ($vehicleData['admin_approval'] == 2) ? 'selected' : '' ?>>Deactivated</option>
                      </select> 
