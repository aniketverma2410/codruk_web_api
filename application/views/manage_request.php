                ...
                <tbody>
                  <?php 
                    ...
                    foreach($result as $list){ 
                      ...
                      $owner_data = $this->db->get_where('owner_master',array('id'=>$list['owner_id']))->row_array();
                  ?>
                     <tr>
                       <td><?php echo $count; ?></td>
                      <!--  <td><?php echo !empty($vechData['image']) ? '<img src="'.base_url('mediaFile/vehicles/').$vechData['image'].'" width="100" height="80">' : ''; ?></td> -->
                      <td><?php echo ucfirst($owner_data['name']); ?><br><i class="fa fa-mobile"></i> <?php echo $owner_data['mobile']?></td>
                       <td><?php echo ucfirst($driver_data['name']); ?><br><i class="fa fa-mobile"></i> <?php echo $driver_data['mobile']?></td>
                      ...
                      <td><?php 
                       ...
                       <td>
                        <a href="<?php echo base_url('Admin/update_request/'); ?><?php echo $list['request_id']; ?>" title="" class="btn btn-info btn-sm">View/Edit</a>
                      </td>
                      </tr>
                    <?php $count++; } ?>        
