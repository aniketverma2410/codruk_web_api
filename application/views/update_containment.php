...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ul class="nav nav-tabs">
          ...
          <li><a  href="<?php echo base_url('Admin/update_registration_doc/'.$id) ?>">Registration Documents</a></li>
          <li><a  href="<?php echo base_url('Admin/update_route_permit/'.$id) ?>">Route Permit</a></li>
          <li class="active" ><a  href="<?php echo base_url('Admin/update_containment/'.$id) ?>">Containment</a></li>
        </ul>
      <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
          <div class="box">
           <div  id="hiddenSms"><?php echo $this->session->flashdata('message'); ?></div>
            <!-- /.box-header -->
            <div class="box-body">
                <form class="form-horizontal" action="<?php echo base_url('Admin/update_containment'); ?>" enctype="multipart/form-data"  method="post" > 
                ...
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    <input type="hidden" name="containment_front" value="" id="file_name_1">
                    ...
                    <span id="err_input_files_1" class="user_err"></span>
                     ...
                     <?php if (!empty($vehicleData['containment_front'])) {?>
                        ...
                        <?php }else{ ?>
                           <div class="col-sm-12" id="set_images_1" style="padding:0px;"><div class="col-xs-12 set_w_admin " id="img_preview_1"><img src="<?php echo $img_name1; ?>" class="set_image" alt="" id="set_image_1"><div class="col-xs-12 set_success"><span class="success">Success</span></div><div class="progress col-xs-12 divPadding" style="margin: 0;"><div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="width:100%"></div></div></div></div>
                        <?php }?>  
                      </div>
                  </div>
                  <div class="col-sm-6">
                      ...
                      <input type="file" name="input_files_2[]" id="input_files_2" placeholder="" class="form-control" onchange="uploadVideo(this, '2')">
                        ...
                        <input type="hidden" name="containment_back" value="" id="file_name_2">
                     ...
                     <?php if (!empty($vehicleData['containment_back'])) {?>
