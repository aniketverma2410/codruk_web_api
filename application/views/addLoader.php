        ...
        <div class="col-xs-12">
          <div class="box">
           <div  id="hiddenSms"><?php echo $this->session->flashdata('message'); ?></div>
            <!-- /.box-header -->
            <div class="box-body">
                <form class="form-horizontal" action="<?php echo base_url('Admin/addLoaderPost'); ?>" enctype="multipart/form-data"  method="post" > 
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                      <label>Loader Count:</label>
                       <input type="number" class="form-control" name="loaderCount"  required="">
                  </div>
                </div> <br> 
