        ...
        <div class="col-xs-12">
          <div class="box">
           <div  id="hiddenSms"><?php echo $this->session->flashdata('message'); ?></div>
            <!-- /.box-header -->
            <div class="box-body">
                <form class="form-horizontal" action="<?php echo base_url('Admin/updateUnitPost'); ?>" enctype="multipart/form-data" method="post" > 
                       ...
                       <select class="form-control" name="unit_type" >
                        <option value="">Select</option>
                          <?php foreach ($result as $key => $value) { ?>
                            <option value="<?php echo $value['id']; ?>" <?php echo ($data['unit_type'] == $value['id']) ? 'selected' : ''; ?>><?php echo $value['name']; ?></option>
                          <?php } ?>
